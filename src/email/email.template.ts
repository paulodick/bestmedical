...
// ===== Redefinição de senha — Controle Financeiro Pessoal =====
export function montarEmailRedefinirSenhaPessoal(
  link: string,
): { assunto: string; html: string } {
  const assunto = 'Redefinir senha — Controle Financeiro Pessoal';
  ...
  <div style="font-family: Arial, Helvetica, sans-serif; color:#0f172a; max-width:560px; margin:0 auto;">
    ...
    <p style="font-size:14px; line-height:1.6;">
      Foi solicitada a redefinição da senha de acesso ao Controle Financeiro Pessoal.
    </p>
    <p style="font-size:14px; line-height:1.6;">
      Clique no botão abaixo para definir uma nova senha. Este link expira em 1 hora.
    </p>

    <div style="text-align:center; margin:24px 0;">
      <a href="${link}"
         style="display:inline-block; background:#0d7d8a; color:#ffffff; text-decoration:none;
    ...
    <div style="margin-top:24px; padding-top:16px; border-top:1px solid #e2e8f0; text-align:center;">
      <div style="font-size:13px; font-weight:bold; font-style:italic; color:#0d7d8a;">When uptime matters.</div>
      <div style="font-size:11px; color:#94a3b8; margin-top:4px;">Best Medical</div>
    </div>
  </div>`;
